...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-lg">
        {/* 404 Number */}
        <div className="mb-6">
          <span className="text-[10rem] md:text-[12rem] font-bold leading-none bg-gradient-to-br from-[#0B3C5D] via-[#2563EB] to-[#0B3C5D] bg-clip-text text-transparent">
            404
          </span>
        </div>
